const paragraphs = [
  ...
  "Many people say that life isn't like a bed of roses I beg to differ I think that life is quite like a bed of roses Just like life, a bed of roses looks pretty on the outside, but when you're in it, you find that it is nothing but thorns and pain I myself have been pricked quite badly You appreciate each day and are thankful you are alive An hour is the same amount of time for everyone yet it can feel so different in how it goes by",

  "They had always called it the green river It made sense The river was green The river likely had a different official name, but to everyone in town, it was and had always been the green river So it was with great surprise that on this day the green river was a fluorescent pink It had been her dream for years but Dana had failed to take any action toward making it come true There had always been a good excuse to delay or prioritize another project",

  "All her instincts and intuition completely failed her for the first time in her lifeShe had so heavily relied on both when making decisions up until this moment and she felt a seismic shift take place in her self-confidenceIf she could be so completely wrong about something so simple as this, how could she make decisions about really important things taking place in her life? She wasn't sure what she should do next",

  "This is important to remember Love isn't like pie You don't need to divide it among all your friends and loved ones No matter how much love you give, you can always give more It doesn't run out, so don't try to hold back giving it as if it may one day run out Give it freely and as much as you want Thirty minutes later they were safe and that was when it dawned on them that they had forgotten the most important thing of all",

  "One can cook on and with an open fire These are some of the ways to cook with fire outside Cooking meat using a spit is a great way to evenly cook meat In order to keep meat from burning, it's best to slowly rotate it Hot stones can be used to toast bread Coals are hot and can bring things to a boil quickly If one is very adventurous, one can make a hole in the ground, fill it with coals and place foil-covered meat, veggies, and potatoes into the coals, and cover all of it with dirt",
];

const randomPara = Math.floor(Math.random() * paragraphs.length);

const paragraphData = paragraphs[randomPara];
